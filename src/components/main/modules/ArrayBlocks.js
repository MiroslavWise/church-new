...
const itemsMeeting = [
        ...
        },
        {
                ...
                description: 'Братские встречи дают много возможностей для общения, молитвы друг за друга и за церковь..... ну и не только.. лучше один раз прийти и увидеть, чтобы убедиться в огромной пользе этих уникальных втреч )))))))))))'
        },
]
