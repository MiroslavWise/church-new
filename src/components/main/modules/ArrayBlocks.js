...
const itemsMeeting = [
        ...
        },
        {
                ...
                description: 'Братские встречи предназначеы для мужчин всех возрастов. Братья вместе обсуждают текущие вопросы церкви, изучают различные темы в свете Библии, молятся друг за друга. Встречи проходят каждый понедельник в 19:00.'
        },
        {
