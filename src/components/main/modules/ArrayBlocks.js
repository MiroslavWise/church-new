...
const questions = [
        {
                ...
                description: 'Да, церковь евангельских христиан баптистов является христианской общиной и действует в рамках Закона Республики Беларусь О свободе совести и религиозных организациях от 17 декабря 1992 г.'
        },
        {
                title: 'Должен ли я быть членом вашей церкви, чтобы посетить ваши служения? ',
                description: 'Нет. Добро пожаловать, независимо от того, откуда вы или кто вы. Мы открыты для всех и у любого человека есть возможность познакомиться с нами и посетить наши служения.'
        },
        {
        ...
        },
        {
                ...
                description: 'Во время собрания мы слушаем Слово Божье, поём, молимся и иногда разговариваем. Вы можете быть только наблюдателем того, что мы делаем. Приходите как есть, у нас нет особого воскресного дресс-кода.'
        },
        {
                title: 'Могу ли я прийти к вам на служение вместе со своими детьми?',
